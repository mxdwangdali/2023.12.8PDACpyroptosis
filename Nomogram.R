...
riskFile="TCGA.txt"       #风险输入文件
cliFile="TCGA.clinical.modified.txt"        #临床数据文件
setwd("C:\\Users\\Kangtao Wang\\Desktop\\pyroptosis and PC\\model and validation\\13.Nomo")     #修改工作目录
...
rt=cbind(risk1[,c("futime", "fustat", "riskScore","risk")], cli)
write.table(rt,file="combine.TCGa.modified.txt",sep="\t", col.names=T, quote=F)
